...
export default function SettingsIcon({active=false}:SettingsIconProps) {
  // Use contrasting colors
  const fillColor = active ? "#FFFFFF" : "none"; // White fill when active
  const strokeColor = active ? "#FFFFFF" : "#9CA3AF"; // White stroke when active, gray when inactive
